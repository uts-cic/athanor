...
if ostype=="Darwin":
    ...
    f.write("\n")
    f.write("#Python\n")
    f.write("INCLUDEPYTHON = -I/System/Library/Frameworks/Python.framework/Versions/2.7/include/python2.7\n")
    f.write("PYTHONLIB = /System/Library/Frameworks/Python.framework/Versions/2.7/lib\n\n")

...
#ifndef atanorimatrix_h
#define atanorimatrix_h
...
class Atanorimatrix;
//This typedef defines a type "imatrixMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanorimatrix::*imatrixMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);

//---------------------------------------------------------------------------------------------------------------------

//---------------------------------------------------------------------------------------------------------------------
class Atanorimatrix : public AtanorObject {
public:
	//We export the methods that will be exposed for our new object
	//this is a static object, which is common to everyone
	//We associate the method pointers with their names in the linkedmethods map
	static Exchanging hmap<unsigned short, imatrixMethod> methods;
	...
	//---------------------------------------------------------------------------------------------------------------------
	Atanorimatrix(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
	...
	Atanor* Newinstance(short, Atanor* f = NULL) {
		return new Atanorimatrix;
	}
	AtanorIteration* Newiteration(bool direction) {
		return aITERNULL;
	}
	static void AddMethod(AtanorGlobal* g, string name, imatrixMethod func, unsigned long arity, string infos);
	...
	void populate(Atanorimatrix* ke) {
		ke->cleaning();
	...
	int LUDCMP(int n, VECTE<int>& INDX, int& d, Atanorimatrix& m) {
	...
	void LUBKSB(int n, VECTE<int>& INDX, VECTE<double>& B, Atanorimatrix& m)  {
		double SUM;
		int  I, II, J, LL;
	...
	int determinant(long rsize, long csize, KIFMATRIX<KIFLINEINTEGER>& m) {
		if (rsize == 2 && csize == 2) {
			//then in that case
	...
	bool inversion(Atanorimatrix& Y) {
		//else Local decomposition

		Y.init(rowsize, columnsize);

		Atanorimatrix m(NULL, NULL);
		populate(&m);
	...
	Atanorimatrix* duplicate() {
		Atanorimatrix* ke = new Atanorimatrix;
	...
	Atanor* orset(Atanor* b, bool autoself) {
		...
		Locking _lock(this);
		Atanorimatrix* ma = this;
		Atanorimatrix* mb = (Atanorimatrix*)b;
	...
	Atanor* divide(Atanor* b, bool autoself) {
		...
		Atanorimatrix inverted(NULL, NULL);
...
class AtanorIterationimatrix : public AtanorIteration {
public:
	Atanorimatrix* value;
	long r;
	long c;
	...
	AtanorIterationimatrix(Atanorimatrix* v, bool d, AtanorGlobal* g = NULL) : _lock(v), AtanorIteration(d, g) {
		value = v;
	}

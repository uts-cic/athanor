...
#ifndef Atanormapul_h
#define Atanormapul_h
...
class Atanormapul;
//This typedef defines a type "mapulMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanormapul::*mapulMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanormapul : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, mapulMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanormapul(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    static void AddMethod(AtanorGlobal* global, string name, mapulMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationmapul : public AtanorIteration {
    public:

    hmap<wstring, BLONG>::iterator it;
    Atanormapul map;

    AtanorIterationmapul(Atanormapul* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

...
#ifndef Atanortreemapif_h
#define Atanortreemapif_h
...
class Atanortreemapif;
//This typedef defines a type "treemapifMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanortreemapif::*treemapifMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanortreemapif : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, treemapifMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanortreemapif(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    Atanor* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Atanortreemapif * m = new Atanortreemapif;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(AtanorGlobal* global, string name, treemapifMethod func, unsigned long arity, string infos);
    ...
    Atanor* MethodItems(Atanor* contextualpattern, short idthread, AtanorCall* callfunc) {
        ...
        Atanortreemapif* item;
        Atanor* vect = Selectavector(contextualpattern);
        for (auto& itr : values) {
            item=new Atanortreemapif;
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationtreemapif : public AtanorIteration {
    public:

    map<long, double>::iterator it;
    Atanortreemapif map;

    AtanorIterationtreemapif(Atanortreemapif* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

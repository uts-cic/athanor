...
#ifndef Atanortreemapls_h
#define Atanortreemapls_h
...
class Atanortreemapls;
//This typedef defines a type "treemaplsMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanortreemapls::*treemaplsMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanortreemapls : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, treemaplsMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanortreemapls(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    Atanor* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Atanortreemapls * m = new Atanortreemapls;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(AtanorGlobal* global, string name, treemaplsMethod func, unsigned long arity, string infos);
    ...
    Atanor* MethodItems(Atanor* contextualpattern, short idthread, AtanorCall* callfunc) {
        ...
        Atanortreemapls* item;
        Atanor* vect = Selectavector(contextualpattern);
        for (auto& itr : values) {
            item=new Atanortreemapls;
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationtreemapls : public AtanorIteration {
    public:

    map<BLONG, string>::iterator it;
    Atanortreemapls map;

    AtanorIterationtreemapls(Atanortreemapls* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

...
#ifndef Atanormapls_h
#define Atanormapls_h
...
class Atanormapls;
//This typedef defines a type "maplsMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanormapls::*maplsMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanormapls : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, maplsMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanormapls(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    static void AddMethod(AtanorGlobal* global, string name, maplsMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationmapls : public AtanorIteration {
    public:

    hmap<BLONG, string>::iterator it;
    Atanormapls map;

    AtanorIterationmapls(Atanormapls* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

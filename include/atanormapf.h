...
class Atanormapf;
//This typedef defines a type "mapfMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanormapf::*mapfMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanormapf : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, mapfMethod> methods;
    ...
    hmap<double, Atanor*> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Atanormapf(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    double Sum() {
        Locking _lock(this);
        double v = 0;
        hmap<double, Atanor*>::iterator itx;
    ...
    Atanor* Newinstance(short idthread, Atanor* f = NULL) {
        return new Atanormapf();
    }

    Exporting AtanorIteration* Newiteration(bool direction);


    static void AddMethod(AtanorGlobal* g, string name, mapfMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationmapf : public AtanorIteration {
    public:
    ...
    AtanorIterationmapf(Atanormapf* m, bool d, AtanorGlobal* g = NULL) : map(m), _lock(m), AtanorIteration(d, g) {}

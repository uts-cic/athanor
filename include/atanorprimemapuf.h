...
#ifndef Atanorprimemapuf_h
#define Atanorprimemapuf_h
...
class Atanorprimemapuf;
//This typedef defines a type "primemapufMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanorprimemapuf::*primemapufMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanorprimemapuf : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, primemapufMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanorprimemapuf(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    short Type() {
        return Atanorprimemapuf::idtype;
    }
    ...
    Atanor* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Atanorprimemapuf * m = new Atanorprimemapuf;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(AtanorGlobal* global, string name, primemapufMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationprimemapuf : public AtanorIteration {
    public:

    prime_hash<wstring, double>::iterator it;
    Atanorprimemapuf map;

    AtanorIterationprimemapuf(Atanorprimemapuf* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

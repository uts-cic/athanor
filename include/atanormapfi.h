...
#ifndef Atanormapfi_h
#define Atanormapfi_h
...
class Atanormapfi;
//This typedef defines a type "mapfiMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanormapfi::*mapfiMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanormapfi : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, mapfiMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanormapfi(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    static void AddMethod(AtanorGlobal* global, string name, mapfiMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationmapfi : public AtanorIteration {
    public:

    hmap<double, long>::iterator it;
    Atanormapfi map;

    AtanorIterationmapfi(Atanormapfi* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

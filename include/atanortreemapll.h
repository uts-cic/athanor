...
#ifndef Atanortreemapll_h
#define Atanortreemapll_h
...
class Atanortreemapll;
//This typedef defines a type "treemapllMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanortreemapll::*treemapllMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanortreemapll : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, treemapllMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanortreemapll(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    Atanor* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Atanortreemapll * m = new Atanortreemapll;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(AtanorGlobal* global, string name, treemapllMethod func, unsigned long arity, string infos);
    ...
    Atanor* MethodItems(Atanor* contextualpattern, short idthread, AtanorCall* callfunc) {
        ...
        Atanortreemapll* item;
        Atanor* vect = Selectavector(contextualpattern);
        for (auto& itr : values) {
            item=new Atanortreemapll;
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationtreemapll : public AtanorIteration {
    public:

    map<BLONG, BLONG>::iterator it;
    Atanortreemapll map;

    AtanorIterationtreemapll(Atanortreemapll* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

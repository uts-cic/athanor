...
#ifndef Atanorbinmapi_h
#define Atanorbinmapi_h
...
class Atanorbinmapi;
//This typedef defines a type "binmapiMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanorbinmapi::*binmapiMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanorbinmapi : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, binmapiMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanorbinmapi(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    Atanor* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Atanorbinmapi * m = new Atanorbinmapi;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(AtanorGlobal* global, string name, binmapiMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationbinmapi : public AtanorIteration {
    public:

    basebin_hash<long>::iterator it;
    Atanorbinmapi map;

    AtanorIterationbinmapi(Atanorbinmapi* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

...
#ifndef Atanorbinmapl_h
#define Atanorbinmapl_h
...
class Atanorbinmapl;
//This typedef defines a type "binmaplMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanorbinmapl::*binmaplMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanorbinmapl : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, binmaplMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanorbinmapl(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    Atanor* Atom(bool forced) {
        if (forced) {
            Locking _lock(this);
            Atanorbinmapl * m = new Atanorbinmapl;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(AtanorGlobal* global, string name, binmaplMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationbinmapl : public AtanorIteration {
    public:

    basebin_hash<BLONG>::iterator it;
    Atanorbinmapl map;

    AtanorIterationbinmapl(Atanorbinmapl* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

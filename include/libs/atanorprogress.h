...
#ifndef atanorprogress_h
#define atanorprogress_h
#include "atanorwidget.h"

//We create a map between our methods, which have been declared in our class below. See MethodInitialization for an example
//of how to declare a new method.
class Atanorprogress;
//This typedef defines a type "progressMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanorprogress::*progressMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);

//---------------------------------------------------------------------------------------------------------------------

class Atanorprogress : public Atanorwidget {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static hmap<short, progressMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
	Atanorprogress(AtanorGlobal* g, Atanor* parent = NULL) : Atanorwidget(g, parent) {
    ...
    Atanor* Newinstance(short, Atanor* f = NULL) {
		Atanorprogress* a = new Atanorprogress(globalAtanor);
		a->function = f;
		return a;
    }
    ...
    static void AddMethod(AtanorGlobal* g, string name, progressMethod func, unsigned long arity, string infos);
	...
	Atanor* MethodMinimum(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
	Atanor* MethodMaximum(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);

...
#ifndef atanorbutton_h
#define atanorbutton_h
#include "atanorwidget.h"

//We create a map between our methods, which have been declared in our class below. See MethodInitialization for an example
//of how to declare a new method.
class Atanorbutton;
//This typedef defines a type "buttonMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanorbutton::*buttonMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);

//---------------------------------------------------------------------------------------------------------------------

class Atanorbutton : public Atanorwidget {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static hmap<short, buttonMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
	Atanorbutton(AtanorGlobal* g, Atanor* parent = NULL) : Atanorwidget(g, parent) {
    ...
    Atanor* Newinstance(short, Atanor* f = NULL) {
		Atanorbutton* a = new Atanorbutton(globalAtanor);
		a->function = f;
		return a;
    }
    ...
    static void AddMethod(AtanorGlobal* g, string name, buttonMethod func, unsigned long arity, string infos);
	...
	Atanor* MethodShortcut(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);

...
class Atanorbox;
//This typedef defines a type "boxMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanorbox::*boxMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);

//---------------------------------------------------------------------------------------------------------------------

class Atanorbox : public Atanorwidget {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static hmap<short, boxMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
	Atanorbox(AtanorGlobal* g, Atanor* parent = NULL) : Atanorwidget(g, parent) {
    ...
    Atanor* Newinstance(short, Atanor* f = NULL) {
		Atanorbox* a=new Atanorbox(globalAtanor);
		a->function = f;
		return a;
    }
    ...
    static void AddMethod(AtanorGlobal* g, string name, boxMethod func, unsigned long arity, string infos);

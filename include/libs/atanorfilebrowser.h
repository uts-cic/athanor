...
#ifndef atanorfilebrowser_h
#define atanorfilebrowser_h
#include "atanorwidget.h"

//We create a map between our methods, which have been declared in our class below. See MethodInitialization for an example
//of how to declare a new method.
class Atanorfilebrowser;
//This typedef defines a type "filebrowserMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanorfilebrowser::*filebrowserMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);

//---------------------------------------------------------------------------------------------------------------------

class Atanorfilebrowser : public Atanorwidget {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static hmap<short, filebrowserMethod> methods;
	...
	char txt[1024];
    //---------------------------------------------------------------------------------------------------------------------
	Atanorfilebrowser(AtanorGlobal* g, Atanor* parent = NULL) : Atanorwidget(g, parent) {
    ...
    short Type() {
        return Atanorfilebrowser::idtype;
    }
    ...
    Atanor* Newinstance(short, Atanor* f = NULL) {
		Atanorfilebrowser* a = new Atanorfilebrowser(globalAtanor);
		a->function = f;
		return a;
	}
    ...
    static void AddMethod(AtanorGlobal* g, string name, filebrowserMethod func, unsigned long arity, string infos);
	...
	Atanor* MethodOk(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);

...
#ifndef atanorcounter_h
#define atanorcounter_h

#include "atanorwidget.h"
//We create a map between our methods, which have been declared in our class below. See MethodInitialization for an example
//of how to declare a new method.
class Atanorcounter;
//This typedef defines a type "counterMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanorcounter::*counterMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);

//---------------------------------------------------------------------------------------------------------------------

class Atanorcounter : public Atanorwidget {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static hmap<short, counterMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
	Atanorcounter(AtanorGlobal* g, Atanor* parent = NULL) : Atanorwidget(g, parent) {
    ...
    Atanor* Newinstance(short, Atanor* f = NULL) {
		Atanorcounter* a = new Atanorcounter(globalAtanor);
		a->function = f;
		return a;
    }
    ...
    static void AddMethod(AtanorGlobal* g, string name, counterMethod func, unsigned long arity, string infos);
	...
	Atanor* MethodLargeStep(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
	Atanor* MethodSteps(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
	...
	Atanor* MethodTextColor(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);

...
#ifndef atanorchoice_h
#define atanorchoice_h
...
public:
	...
	ChoiceCallback(Atanor* func, Atanor* o, Atanorchoice* ch) {
		function = func;
		choice = ch;
		object = o;
	}
...
class Atanorchoice;
//This typedef defines a type "choiceMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanorchoice::*choiceMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);

//---------------------------------------------------------------------------------------------------------------------

class Atanorchoice : public Atanorwidget {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static hmap<short, choiceMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
	Atanorchoice(AtanorGlobal* g, Atanor* parent = NULL) : Atanorwidget(g, parent) {
    ...
    Atanor* Newinstance(short, Atanor* f = NULL) {
		Atanorchoice* a = new Atanorchoice(globalAtanor);
		a->function = f;
		return a;
    }
    ...
    static void AddMethod(AtanorGlobal* g, string name, choiceMethod func, unsigned long arity, string infos);

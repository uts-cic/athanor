...
class Atanormapu;
//This typedef defines a type "mapuMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanormapu::*mapuMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanormapu : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, mapuMethod> methods;
    ...
    hmap<wstring, Atanor*> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Atanormapu(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    double Sum() {
        Locking _lock(this);
        double v = 0;
        hmap<wstring, Atanor*>::iterator itx;
    ...
    Atanor* Newinstance(short idthread, Atanor* f = NULL) {
        return new Atanormapu();
    }

    Exporting AtanorIteration* Newiteration(bool direction);


    static void AddMethod(AtanorGlobal* global, string name, mapuMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationmapu : public AtanorIteration {
    public:
    ...
    AtanorIterationmapu(Atanormapu* m, bool d, AtanorGlobal* g = NULL) : map(m), _lock(m), AtanorIteration(d, g) {}

...
#ifndef Atanorprimemapii_h
#define Atanorprimemapii_h
...
class Atanorprimemapii;
//This typedef defines a type "primemapiiMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanorprimemapii::*primemapiiMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanorprimemapii : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, primemapiiMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanorprimemapii(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    short Type() {
        return Atanorprimemapii::idtype;
    }
    ...
    Atanor* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Atanorprimemapii * m = new Atanorprimemapii;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(AtanorGlobal* global, string name, primemapiiMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationprimemapii : public AtanorIteration {
    public:

    prime_hash<long, long>::iterator it;
    Atanorprimemapii map;

    AtanorIterationprimemapii(Atanorprimemapii* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

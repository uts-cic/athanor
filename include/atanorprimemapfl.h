...
#ifndef Atanorprimemapfl_h
#define Atanorprimemapfl_h
...
class Atanorprimemapfl;
//This typedef defines a type "primemapflMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanorprimemapfl::*primemapflMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanorprimemapfl : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, primemapflMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanorprimemapfl(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    short Type() {
        return Atanorprimemapfl::idtype;
    }
    ...
    Atanor* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Atanorprimemapfl * m = new Atanorprimemapfl;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(AtanorGlobal* global, string name, primemapflMethod func, unsigned long arity, string infos);
    ...
    Atanor* Value(BLONG n) {
        if (values.find((double)n) == values.end())
            return aNOELEMENT;
        return new Atanorlong(values[(double)n]);
    }
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationprimemapfl : public AtanorIteration {
    public:

    prime_hash<double, BLONG>::iterator it;
    Atanorprimemapfl map;

    AtanorIterationprimemapfl(Atanorprimemapfl* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

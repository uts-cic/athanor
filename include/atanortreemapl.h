...
#ifndef Atanortreemapl_h
#define Atanortreemapl_h
...
class Atanortreemapl;
//This typedef defines a type "treemaplMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanortreemapl::*treemaplMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanortreemapl : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, treemaplMethod> methods;
    ...
    map<BLONG, Atanor*> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Atanortreemapl(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    Atanor* Atom(bool forced) {
        if (forced) {
            Atanortreemapl* m = new Atanortreemapl;
            Locking _lock(this);
            Atanor* v;
    ...
    Atanor* Newinstance(short idthread, Atanor* f = NULL) {
        return new Atanortreemapl();
    }

    Exporting AtanorIteration* Newiteration(bool direction);


    static void AddMethod(AtanorGlobal* g, string name, treemaplMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationtreemapl : public AtanorIteration {
    public:
    ...
    AtanorIterationtreemapl(Atanortreemapl* m, bool d, AtanorGlobal* g = NULL) : map(m), _lock(m), AtanorIteration(d, g) {}

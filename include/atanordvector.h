...
#ifndef atanordvector_h
#define atanordvector_h
...
class Atanordvector;
//This typedef defines a type "dvectorMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanordvector::*dvectorMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------

class Atanordvector : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, dvectorMethod> methods;
	...
	bool isconst;
    //---------------------------------------------------------------------------------------------------------------------
    Atanordvector(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    Atanor* Atom(bool forced = false) {
        if (forced || !protect || reference) {
            Atanordvector* v = new Atanordvector;
            Locking _lock(this);
            v->values = values;
            return v;
        }
    ...
    static void AddMethod(AtanorGlobal* g, string name, dvectorMethod func, unsigned long arity, string infos);
    ...
    Atanor* Inverse() {
        Locking _lock(this);
        Atanordvector* vect = new Atanordvector;
...
class AtanorIterationdvector : public AtanorIteration {
    public:
    BLONG itx;
    Atanordvector* ref;
    Locking _lock;

    AtanorIterationdvector(Atanordvector* v, bool d, AtanorGlobal* g = NULL) : _lock(v), AtanorIteration(d, g) {
        ref = v;
        itx = 0;
    }

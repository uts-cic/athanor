...
#ifndef Atanorprimemapff_h
#define Atanorprimemapff_h
...
class Atanorprimemapff;
//This typedef defines a type "primemapffMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanorprimemapff::*primemapffMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanorprimemapff : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, primemapffMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanorprimemapff(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    short Type() {
        return Atanorprimemapff::idtype;
    }
    ...
    Atanor* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Atanorprimemapff * m = new Atanorprimemapff;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(AtanorGlobal* global, string name, primemapffMethod func, unsigned long arity, string infos);
    ...
    Atanor* Value(long n) {
        ...
        if (values.find((double)n) == values.end())
            return aNOELEMENT;
        return globalAtanor->Providefloat(values[(double)n]);
    }
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationprimemapff : public AtanorIteration {
    public:

    prime_hash<double, double>::iterator it;
    Atanorprimemapff map;

    AtanorIterationprimemapff(Atanorprimemapff* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

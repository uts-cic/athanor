...
#ifndef Atanortreemapf_h
#define Atanortreemapf_h
...
class Atanortreemapf;
//This typedef defines a type "treemapfMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanortreemapf::*treemapfMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanortreemapf : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, treemapfMethod> methods;
    ...
    map<double, Atanor*> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Atanortreemapf(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    Atanor* Atom(bool forced) {
        if (forced) {
            Atanortreemapf* m = new Atanortreemapf;
            Locking _lock(this);
            Atanor* v;
    ...
    double Sum() {
        Locking _lock(this);
        double v = 0;
        map<double, Atanor*>::iterator itx;
    ...
    Atanor* Newinstance(short idthread, Atanor* f = NULL) {
        return new Atanortreemapf();
    }

    Exporting AtanorIteration* Newiteration(bool direction);


    static void AddMethod(AtanorGlobal* g, string name, treemapfMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationtreemapf : public AtanorIteration {
    public:
    ...
    AtanorIterationtreemapf(Atanortreemapf* m, bool d, AtanorGlobal* g = NULL) : map(m), _lock(m), AtanorIteration(d, g) {}

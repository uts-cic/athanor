...
#ifndef Atanortreemaplu_h
#define Atanortreemaplu_h
...
class Atanortreemaplu;
//This typedef defines a type "treemapluMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanortreemaplu::*treemapluMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanortreemaplu : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, treemapluMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanortreemaplu(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    Atanor* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Atanortreemaplu * m = new Atanortreemaplu;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(AtanorGlobal* global, string name, treemapluMethod func, unsigned long arity, string infos);
    ...
    Atanor* MethodItems(Atanor* contextualpattern, short idthread, AtanorCall* callfunc) {
        ...
        Atanortreemaplu* item;
        Atanor* vect = Selectavector(contextualpattern);
        for (auto& itr : values) {
            item=new Atanortreemaplu;
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationtreemaplu : public AtanorIteration {
    public:

    map<BLONG, wstring>::iterator it;
    Atanortreemaplu map;

    AtanorIterationtreemaplu(Atanortreemaplu* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

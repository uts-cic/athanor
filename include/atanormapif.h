...
#ifndef Atanormapif_h
#define Atanormapif_h
...
class Atanormapif;
//This typedef defines a type "mapifMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanormapif::*mapifMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanormapif : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, mapifMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanormapif(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    static void AddMethod(AtanorGlobal* global, string name, mapifMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationmapif : public AtanorIteration {
    public:

    hmap<long, double>::iterator it;
    Atanormapif map;

    AtanorIterationmapif(Atanormapif* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

...
#ifndef Atanortreemapul_h
#define Atanortreemapul_h
...
class Atanortreemapul;
//This typedef defines a type "treemapulMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanortreemapul::*treemapulMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanortreemapul : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, treemapulMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanortreemapul(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    Atanor* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Atanortreemapul * m = new Atanortreemapul;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(AtanorGlobal* global, string name, treemapulMethod func, unsigned long arity, string infos);
    ...
    Atanor* MethodItems(Atanor* contextualpattern, short idthread, AtanorCall* callfunc) {
        ...
        Atanortreemapul* item;
        Atanor* vect = Selectavector(contextualpattern);
        for (auto& itr : values) {
            item=new Atanortreemapul;
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationtreemapul : public AtanorIteration {
    public:

    map<wstring, BLONG>::iterator it;
    Atanortreemapul map;

    AtanorIterationtreemapul(Atanortreemapul* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

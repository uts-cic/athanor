...
#ifndef Atanorprimemapi_h
#define Atanorprimemapi_h
...
class Atanorprimemapi;
//This typedef defines a type "primemapiMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanorprimemapi::*primemapiMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanorprimemapi : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, primemapiMethod> methods;
    ...
    prime_hash<long, Atanor*> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Atanorprimemapi(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    Atanor* Atom(bool forced) {
        if (forced) {
            Atanorprimemapi* m = new Atanorprimemapi;
            Locking _lock(this);
            Atanor* v;
            prime_hash<long, Atanor*>::iterator it;
            for (it = values.begin(); it != values.end(); it++) {
    ...
    Atanor* Newinstance(short idthread, Atanor* f = NULL) {
        return new Atanorprimemapi();
    }

    Exporting AtanorIteration* Newiteration(bool direction);


    static void AddMethod(AtanorGlobal* global, string name, primemapiMethod func, unsigned long arity, string infos);
    ...
    Atanor* MethodItems(Atanor* contextualpattern, short idthread, AtanorCall* callfunc) {
        prime_hash<long, Atanor*>::iterator itr;
        Atanorprimemapi* item;
        Atanor* vect = Selectavector(contextualpattern);
        for (itr=values.begin(); itr!=values.end();itr++) {
            item=new Atanorprimemapi;
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationprimemapi : public AtanorIteration {
    public:
    ...
    AtanorIterationprimemapi(Atanorprimemapi* m, bool d, AtanorGlobal* g = NULL) : map(m), _lock(m), AtanorIteration(d, g) {}

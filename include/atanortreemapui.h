...
#ifndef Atanortreemapui_h
#define Atanortreemapui_h
...
class Atanortreemapui;
//This typedef defines a type "treemapuiMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanortreemapui::*treemapuiMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanortreemapui : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, treemapuiMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanortreemapui(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    Atanor* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Atanortreemapui * m = new Atanortreemapui;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(AtanorGlobal* global, string name, treemapuiMethod func, unsigned long arity, string infos);
    ...
    Atanor* MethodItems(Atanor* contextualpattern, short idthread, AtanorCall* callfunc) {
        ...
        Atanortreemapui* item;
        Atanor* vect = Selectavector(contextualpattern);
        for (auto& itr : values) {
            item=new Atanortreemapui;
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationtreemapui : public AtanorIteration {
    public:

    map<wstring, long>::iterator it;
    Atanortreemapui map;

    AtanorIterationtreemapui(Atanortreemapui* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

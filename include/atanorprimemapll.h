...
#ifndef Atanorprimemapll_h
#define Atanorprimemapll_h
...
class Atanorprimemapll;
//This typedef defines a type "primemapllMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanorprimemapll::*primemapllMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanorprimemapll : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, primemapllMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanorprimemapll(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    short Type() {
        return Atanorprimemapll::idtype;
    }
    ...
    Atanor* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Atanorprimemapll * m = new Atanorprimemapll;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(AtanorGlobal* global, string name, primemapllMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationprimemapll : public AtanorIteration {
    public:

    prime_hash<BLONG, BLONG>::iterator it;
    Atanorprimemapll map;

    AtanorIterationprimemapll(Atanorprimemapll* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

...
#ifndef Atanorbinmapf_h
#define Atanorbinmapf_h
...
class Atanorbinmapf;
//This typedef defines a type "binmapfMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanorbinmapf::*binmapfMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanorbinmapf : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, binmapfMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanorbinmapf(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    Atanor* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Atanorbinmapf * m = new Atanorbinmapf;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(AtanorGlobal* global, string name, binmapfMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationbinmapf : public AtanorIteration {
    public:

    basebin_hash<double>::iterator it;
    Atanorbinmapf map;

    AtanorIterationbinmapf(Atanorbinmapf* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

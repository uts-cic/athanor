...
#ifndef Atanorprimemapfi_h
#define Atanorprimemapfi_h
...
class Atanorprimemapfi;
//This typedef defines a type "primemapfiMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanorprimemapfi::*primemapfiMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanorprimemapfi : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, primemapfiMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanorprimemapfi(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    short Type() {
        return Atanorprimemapfi::idtype;
    }
    ...
    Atanor* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Atanorprimemapfi * m = new Atanorprimemapfi;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(AtanorGlobal* global, string name, primemapfiMethod func, unsigned long arity, string infos);
    ...
    Atanor* Value(long n) {
        if (values.find((double)n) == values.end())
            return aNOELEMENT;
        return globalAtanor->Provideint(values[(double)n]);
    }
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationprimemapfi : public AtanorIteration {
    public:

    prime_hash<double, long>::iterator it;
    Atanorprimemapfi map;

    AtanorIterationprimemapfi(Atanorprimemapfi* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

...
#ifndef Atanorprimemapf_h
#define Atanorprimemapf_h
...
class Atanorprimemapf;
//This typedef defines a type "primemapfMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanorprimemapf::*primemapfMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanorprimemapf : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, primemapfMethod> methods;
    ...
    prime_hash<double, Atanor*> values;
    bool isconst;

    //---------------------------------------------------------------------------------------------------------------------
    Atanorprimemapf(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    Atanor* Atom(bool forced) {
        if (forced) {
            Atanorprimemapf* m = new Atanorprimemapf;
            Locking _lock(this);
            Atanor* v;
            prime_hash<double, Atanor*>::iterator it;
            for (it = values.begin(); it != values.end(); it++) {
    ...
    Atanor* Newinstance(short idthread, Atanor* f = NULL) {
        return new Atanorprimemapf();
    }

    Exporting AtanorIteration* Newiteration(bool direction);


    static void AddMethod(AtanorGlobal* global, string name, primemapfMethod func, unsigned long arity, string infos);
    ...
    Atanor* MethodItems(Atanor* contextualpattern, short idthread, AtanorCall* callfunc) {
        prime_hash<double, Atanor*>::iterator itr;
        Atanorprimemapf* item;
        Atanor* vect = Selectavector(contextualpattern);
        for (itr = values.begin(); itr != values.end(); itr++) {
            item = new Atanorprimemapf;
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationprimemapf : public AtanorIteration {
    public:
    ...
    AtanorIterationprimemapf(Atanorprimemapf* m, bool d, AtanorGlobal* g = NULL) : map(m), _lock(m), AtanorIteration(d, g) {}

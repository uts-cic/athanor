...
#ifndef Atanormapuf_h
#define Atanormapuf_h
...
class Atanormapuf;
//This typedef defines a type "mapufMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanormapuf::*mapufMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanormapuf : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, mapufMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanormapuf(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    static void AddMethod(AtanorGlobal* global, string name, mapufMethod func, unsigned long arity, string infos);
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationmapuf : public AtanorIteration {
    public:

    hmap<wstring, double>::iterator it;
    Atanormapuf map;

    AtanorIterationmapuf(Atanormapuf* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }

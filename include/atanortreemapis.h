...
#ifndef Atanortreemapis_h
#define Atanortreemapis_h
...
class Atanortreemapis;
//This typedef defines a type "treemapisMethod", which expose the typical parameters of a new KiF method implementation
typedef Atanor* (Atanortreemapis::*treemapisMethod)(Atanor* contextualpattern, short idthread, AtanorCall* callfunc);
//---------------------------------------------------------------------------------------------------------------------
class Atanortreemapis : public AtanorObject {
    public:
    //We export the methods that will be exposed for our new object
    //this is a static object, which is common to everyone
    //We associate the method pointers with their names in the linkedmethods map
    static Exchanging hmap<unsigned short, treemapisMethod> methods;
    ...
    //---------------------------------------------------------------------------------------------------------------------
    Atanortreemapis(AtanorGlobal* g, Atanor* parent = NULL) : AtanorObject(g, parent) {
    ...
    Atanor* Atom(bool forced) {
        if (forced || !protect || reference) {
            Locking _lock(this);
            Atanortreemapis * m = new Atanortreemapis;
            m->values = values;
            return m;
        }
        return this;
    ...
    static void AddMethod(AtanorGlobal* global, string name, treemapisMethod func, unsigned long arity, string infos);
    ...
    Atanor* MethodItems(Atanor* contextualpattern, short idthread, AtanorCall* callfunc) {
        ...
        Atanortreemapis* item;
        Atanor* vect = Selectavector(contextualpattern);
        for (auto& itr : values) {
            item=new Atanortreemapis;
...
//--------------------------------------------------------------------------------------------------
class AtanorIterationtreemapis : public AtanorIteration {
    public:

    map<long, string>::iterator it;
    Atanortreemapis map;

    AtanorIterationtreemapis(Atanortreemapis* m, bool d, AtanorGlobal* g = NULL) : AtanorIteration(d, g) {
        map.values = m->values;
    }
